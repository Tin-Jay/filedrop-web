...
export const port = parseInt(process.env.WS_PORT || '5000', 10);
...
export const maxSize = parseInt(process.env.WS_MAX_SIZE || '65536', 10);
export const maxNetworkClients = parseInt(process.env.WS_MAX_NETWORK_CLIENTS || '64', 10);
...
export const stunServer = process.env.STUN_SERVER || 'stun:stun1.l.google.com:19302';
...
export const turnExpiry = parseInt(process.env.TURN_EXPIRY || '3600', 10);
