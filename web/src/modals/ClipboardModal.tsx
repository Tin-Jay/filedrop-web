...
export const ClipboardModal: React.FC<ClipboardModalProps> = observer(({ files = [], dismissClipboard }) => {
  ...
  return (
    <Modal onClose={dismissClipboard} title={t('clipboard.title')} isOpen={!!files.length}>
      <div className="subsection">
        <div className={styles.file}>{t('clipboard.body', { fileNames })}</div>
