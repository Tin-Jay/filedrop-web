...
export const isClipboardReadSupported = 'clipboard' in navigator && !!navigator.clipboard.read;
export const isBrowserCompatible = isWebRTCSupported && isWebSocketSupported && isFileReaderSupported;
...
export const deviceType: DeviceType = isTablet ? DeviceType.TABLET : isMobile ? DeviceType.MOBILE : DeviceType.DESKTOP;
